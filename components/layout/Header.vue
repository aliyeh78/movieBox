    ...
    <div class="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
      ...
      <div class="flex items-center gap-6">
        ...
        <nav class="flex items-center gap-8 text-text-secondary">
          ...
          <NuxtLink to="/movies" class="hover:text-accent transition">Movies</NuxtLink>
          <NuxtLink to="/series" class="hover:text-accent transition">Series</NuxtLink>
        </nav>
        ...
        <div class="flex items-center gap-2">
          <NuxtLink
            to="/auth"
            class="px-4 py-1 rounded bg-accent text-black font-semibold hover:bg-accent/90 transition"
          >
            Login
          </NuxtLink>
          <NuxtLink
            to="/auth"
            class="px-4 py-1 rounded border border-accent text-accent font-semibold hover:bg-accent/10 transition"
          >
            Sign Up
          </NuxtLink>
        </div>
